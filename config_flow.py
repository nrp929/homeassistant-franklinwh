...
class FranklinWHOptionsFlow(config_entries.OptionsFlow):
    ...
    async def async_step_init(
        ...
        use_sn = self.config_entry.options.get(CONF_USE_SN, False)
        prefix = self.config_entry.options.get(CONF_PREFIX, "")
        tolerate_stale_data = self.config_entry.options.get(CONF_TOLERATE_STALE_DATA, False)
        ...
        data_schema = vol.Schema(
            {
                ...
                vol.Optional(CONF_USE_SN, default=use_sn): cv.boolean,
                vol.Optional(CONF_PREFIX, default=prefix): cv.string,
                vol.Optional(CONF_TOLERATE_STALE_DATA, default=tolerate_stale_data): cv.boolean,
